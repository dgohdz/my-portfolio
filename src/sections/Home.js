                    ...
                    <div className="social-button-container">
                        <ul>
                            <a href="https://github.com/dgohdz" target="_blank" rel="noreferrer"><img src={github}
                                    alt="github icon"
                                    className="github"/></a>
                            <a href="https://drive.google.com/file/d/13203KjaitOUzQSXxXui8HqRx1kIv_g5E/view?usp=sharing" target="_blank" rel="noreferrer"><button className="resume-button">Resume</button></a>
